...
const AGENTS = [
  ...
  { name: "SAIM Commercial", tag: "Ventes",               icon: "🤝",
    ...
    desc: "Scoring de prospects, discours adaptés au marché africain, relances automatiques et suivi pipeline.",
    features: ["Scoring et analyse prospects", "Discours de prospection localisés", "Relances clients et impayés", "Suivi pipeline commercial"],
  },
  { name: "SAIM Juridique",  tag: "Juridique",            icon: "⚖️",
    headline: "Contrats et conformité OHADA.",
    desc: "Rédaction de contrats, analyse d'appels d'offres, veille réglementaire — tout en conformité OHADA et CEMAC.",
    features: ["Contrats, CGV, statuts", "Analyse appels d'offres publics", "Courriers administratifs DGI", "Veille OHADA et CEMAC"],
  },
