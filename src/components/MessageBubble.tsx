    ...
    >
      ...
      <div style={{ color: "#1a1a1a", fontSize: 16, lineHeight: 1.75 }}>
        <ReactMarkdown
          ...
          components={{
            p: ({ children }) => (
              <p style={{ margin: "0 0 14px 0", lineHeight: "1.75", fontSize: "16px", color: "#1a1a1a" }}>
                {children}
              </p>
            ),
            strong: ({ children }) => (
            ...
            ul: ({ children }) => (
              <ul style={{ margin: "8px 0 14px 0", paddingLeft: 22, lineHeight: "1.8", listStyleType: "disc" }}>
                {children}
              </ul>
            ),
            li: ({ children }) => (
            ...
            td: ({ children }) => (
              <td style={{ padding: "10px 14px", borderBottom: "1px solid #f0f0f0", color: "#374151" }}>
                {children}
              </td>
            ),
            code: ({ children }) => (
            ...
            h3: ({ children }) => (
              <h3 style={{ fontSize: "18px", fontWeight: 600, margin: "20px 0 10px 0", color: "#1a1a1a" }}>
                {children}
              </h3>
            ),
            h2: ({ children }) => (
              <h2 style={{ fontSize: "20px", fontWeight: 600, margin: "24px 0 12px 0", color: "#1a1a1a" }}>
                {children}
              </h2>
            ),
          }}
